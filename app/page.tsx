    ...
    <main className="relative isolate min-h-dvh overflow-hidden bg-slate-50 text-slate-900">
      ...
      <div className="relative mx-auto flex min-h-dvh w-full max-w-5xl flex-col items-center justify-center px-4 py-6 sm:px-6 sm:py-10">
        ...
        <div className="mt-5 grid w-full max-w-3xl grid-cols-1 gap-3 sm:mt-9 sm:grid-cols-2 sm:gap-6">
          ...
          <Link
            href="/portal"
            className="group flex flex-col items-center gap-2.5 rounded-[28px] border border-white/80 bg-white/90 p-4 text-center sm:gap-4 shadow-[0_18px_44px_rgba(15,23,42,0.10)] ring-1 ring-slate-100 transition hover:-translate-y-1 hover:shadow-[0_26px_60px_rgba(2,132,199,0.20)] sm:p-9"
          >
            <span className="grid h-11 w-11 place-items-center rounded-2xl sm:h-16 sm:w-16 bg-sky-50 text-sky-600 ring-1 ring-sky-100 transition group-hover:bg-sky-600 group-hover:text-white">
          ...
          <Link
            href="/login"
            className="group flex flex-col items-center gap-2.5 rounded-[28px] border border-white/80 bg-white/90 p-4 text-center sm:gap-4 shadow-[0_18px_44px_rgba(15,23,42,0.10)] ring-1 ring-slate-100 transition hover:-translate-y-1 hover:shadow-[0_26px_60px_rgba(15,23,42,0.18)] sm:p-9"
          >
            <span className="grid h-11 w-11 place-items-center rounded-2xl sm:h-16 sm:w-16 bg-slate-100 text-slate-700 ring-1 ring-slate-200 transition group-hover:bg-slate-900 group-hover:text-white">
              <svg viewBox="0 0 24 24" className="h-6 w-6 sm:h-8 sm:w-8" fill="none" stroke="currentColor" strokeWidth="1.8">
        ...
        <div className="mt-4 flex items-center gap-2 sm:mt-10">
          ...
          <Image
            ...
            width={220}
            height={48}
            className="h-5 w-auto object-contain opacity-80 sm:h-6"
          />
        </div>
      </div>
    </main>
