...
export default async function LandingPage() {
  ...
  return (
    <main className="relative isolate min-h-dvh overflow-hidden bg-slate-50 text-slate-900">
      ...
      <div className="relative mx-auto flex min-h-dvh w-full max-w-5xl flex-col items-center justify-center px-4 py-10 sm:px-6">
        <Image
          ...
          priority
        />
        <h1 className="mt-6 text-center text-[clamp(1.5rem,4vw,2.4rem)] font-black leading-tight tracking-tight text-slate-900">
          Welcome to MedLink
        </h1>
        ...
        <div className="mt-9 grid w-full max-w-3xl grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6">
          {/* General public / patient */}
          <Link
            href="/portal"
            className="group flex flex-col items-center gap-4 rounded-[28px] border border-white/80 bg-white/90 p-7 text-center shadow-[0_18px_44px_rgba(15,23,42,0.10)] ring-1 ring-slate-100 transition hover:-translate-y-1 hover:shadow-[0_26px_60px_rgba(2,132,199,0.20)] sm:p-9"
          >
            <span className="grid h-16 w-16 place-items-center rounded-2xl bg-sky-50 text-sky-600 ring-1 ring-sky-100 transition group-hover:bg-sky-600 group-hover:text-white">
          ...
          <Link
            href="/login"
            className="group flex flex-col items-center gap-4 rounded-[28px] border border-white/80 bg-white/90 p-7 text-center shadow-[0_18px_44px_rgba(15,23,42,0.10)] ring-1 ring-slate-100 transition hover:-translate-y-1 hover:shadow-[0_26px_60px_rgba(15,23,42,0.18)] sm:p-9"
          >
            <span className="grid h-16 w-16 place-items-center rounded-2xl bg-slate-100 text-slate-700 ring-1 ring-slate-200 transition group-hover:bg-slate-900 group-hover:text-white">
              <svg viewBox="0 0 24 24" className="h-8 w-8" fill="none" stroke="currentColor" strokeWidth="1.8">
